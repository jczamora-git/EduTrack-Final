...
const NotificationsPage: React.FC = () => {
  ...
  const teacherNotifications = notifications.filter((n: any) => {
    // show all notifications for teachers; NotificationBell already filters announcements
    return true;
  });
      ...
      <div className="p-8">
        ...
        {teacherNotifications.length === 0 ? (
          ...
          <div className="space-y-3">
            {teacherNotifications.map((n: any) => (
